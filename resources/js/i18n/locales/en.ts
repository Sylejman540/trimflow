export default {
    ...
    no: 'No',
    search: 'Search…',
    searchDesc: 'Search for pages and actions',
    searchPlaceholder: 'Type a command or search…',
    navigation: 'Navigation',
    toOpenSearch: 'to open search',
    filter: 'Filter',
    all: 'All',
    total: 'Total',
    notes: 'Notes',
    ...
    nav: {
        ...
        analyticsDesc: 'Funnels, trends & metrics',
    ...
    land: {
        ...
        // Hero
        heroHeading: 'Run Your Barbershop Without the Chaos',
        heroSub: 'Manage appointments, barbers, services, and revenue from one powerful dashboard.',
        heroBtn: 'Start Free Trial',
        heroBtn2: 'View Demo',
        // Problem & Solution
        problemLabel: 'The Problem',
        problemHeading: 'Barbershop Management is Broken',
        problemSub: 'Missed appointments, double bookings, and no way to track revenue or manage multiple barbers.',
        problem1: 'Missed Appointments',
        problem2: 'Double Bookings',
        problem3: 'Hard to Track Revenue',
        problem4: 'Managing Multiple Barbers Manually',
        solutionLabel: 'The Solution',
        solutionHeading: 'TrimFlow Fixes All of It',
        solutionSub: 'Smart scheduling, real-time analytics, and seamless team management.',
        solution1: 'Smart Appointment Scheduling',
        solution2: 'Intelligent Conflict Prevention',
        solution3: 'Automated Revenue Tracking',
        solution4: 'Powerful Team Management',
        // Features
        featuresLabel: 'Features',
        featuresHeading: 'Everything You Need to Run Your Barbershop',
        featuresSub: 'Professional tools designed specifically for barbers.',
        feature1Title: 'Smart Appointments',
        feature1Desc: 'Drag-and-drop calendar, walk-ins, and online booking management.',
        feature2Title: 'Barber Team Management',
        feature2Desc: 'Manage barbers, schedules, performance, and time off.',
        feature3Title: 'Business Analytics',
        feature3Desc: 'Track revenue, bookings, and performance in real time.',
        feature4Title: 'Product Sales',
        feature4Desc: 'Sell retail products and track inventory seamlessly.',
        feature5Title: 'Online Booking Page',
        feature5Desc: 'Customers can book directly from your public booking link.',
        feature6Title: 'Multi-Language Support',
        feature6Desc: 'Serve customers worldwide in English, Deutsch, and more.',
        // Stats
        statsLabel: 'Trusted by barbershops worldwide',
        stat1Value: '1,200+',
        stat1Label: 'Barbers',
        stat2Value: '15,000+',
        stat2Label: 'Bookings',
        ...
        problemLabel: 'The Problem',
        problemHeading: 'Barbershop management is broken',
        problemSub: "Most shops still use spreadsheets, phone calls, and chaos. Here's what they face:",
        problem1: 'Manual scheduling leads to overbookings and angry customers',
        problem2: 'No way to track barber performance and revenue',
        problem3: "Customers can't book online—you lose sales",
        problem4: 'Payment collection and invoicing is a nightmare',
        solutionLabel: 'The Solution',
        solutionHeading: 'TrimFlow fixes all of it',
        solution1: 'Automated booking system with instant confirmation',
        solution2: 'Real-time dashboards showing every metric that matters',
        solution3: 'White-label booking page drives 3x more revenue',
        solution4: 'Integrated payments and automatic invoicing',
        featuresLabel: 'Features',
        featuresHeading: 'Everything You Need to Run a Modern Barbershop',
        // Footer
