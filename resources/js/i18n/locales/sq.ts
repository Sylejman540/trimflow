export default {
    ...
    no: 'Jo',
    search: 'Kërko…',
    searchDesc: 'Kërko për faqe dhe aksione',
    searchPlaceholder: 'Shkruaj një komandë ose kërkim…',
    navigation: 'Navigim',
    toOpenSearch: 'për të hapur kërkimin',
    filter: 'Filtro',
    all: 'Të gjitha',
    total: 'Total',
    notes: 'Shënime',
    ...
    nav: {
        ...
        analyticsDesc: 'Histograma, tendencat & metrikat',
    ...
    land: {
        ...
        linkCookies: 'Cookies',
        heroBtn: 'Filloni Provën Falas',
        heroBtn2: 'Shiko Demo',
        problemLabel: 'Problemi',
        problemHeading: 'Menaxhimi i berberit është i prishur',
        problemSub: 'Shumica e dyqaneve ende përdorin spreadsheets, telefonata dhe kaos. Ja çfarë përballojnë:',
        problem1: 'Planifikimi manual çon në tepricë dhe klientë të zemëruar',
        problem2: 'Nuk ka mënyra për të ndjekur performancën e berberit dhe të ardhurat',
        problem3: 'Klientët nuk mund të rezervojnë në internet—ju humbisni shitje',
        problem4: 'Mbledhja e pagesave dhe faturat janë një nëndenjë',
        solutionLabel: 'Zgjidhja',
        solutionHeading: 'TrimFlow e rregullon të gjitha',
        solution1: 'Sistem i automatizuar i rezervimit me konfirmim të menjëhershëm',
        solution2: 'Panele në kohë reale që tregojnë çdo metrikë që ka rëndësi',
        solution3: 'Faqja e rezervimit e tipit të bardhë rrit të ardhurat me 3x',
        solution4: 'Pagesa të integruara dhe faturat automatike',
        featuresLabel: 'Karakteristikat',
        featuresHeading: 'Gjithçka që ju duhet për të drejtuar një berber modern',
        feature1Title: 'Planifikimi i Zgjuar',
        feature1Desc: 'Parandaloni dyfishtë rezervimet me zbulim automatik të konflikteve',
        feature2Title: 'Menaxhimi i Ekipit',
        feature2Desc: 'Ndjekje e performancës, vlerësimeve dhe orarit të berberit',
        feature3Title: 'Panela Analitika',
        feature3Desc: 'Shikoni trendet e të ardhurave, kohërat më të zëna dhe njohuritë për klientët',
        feature4Title: 'Katalog Shërbimesh',
        feature4Desc: 'Përshtatni shërbimet, çmimet, kohëzgjatjen dhe kategoritë',
        feature5Title: 'Link Rezervimi',
        feature5Desc: 'Faqe rezervimi e tipit të bardhë me markën tuaj',
        feature6Title: 'Mbështetja Shumëgjuhësh',
        feature6Desc: 'Arritni klientë në 12+ gjuhë',
        statsLabel: 'Besojnë dyqanet e berbershmërisë në të gjithë botën',
        stat1Value: '1,200+',
        stat1Label: 'Berberë aktivë',
        stat2Value: '50K+',
        stat2Label: 'Rezervime mujore',
        stat3Value: '98%',
        stat3Label: 'Shkalla e kënaqësisë',
        pricingLabel: 'Çmimet',
        pricingHeading: 'Çmimi i thjeshtë dhe transparent',
        pricingSub: 'Zgjedhni planin që përshtatet dyqanit tuaj. Nuk ka tarifa setup. Anuloni në çdo kohë.',
        planStarterName: 'Starter',
        planStarterPrice: '$19',
        planStarterDesc: 'Perfekt për berberët vetaks dhe dyqanet e vogla',
        planStarterFeature1: 'Rezervimet e pakufizuara',
        planStarterFeature2: 'Deri në 3 anëtarë ekipi',
        planStarterFeature3: 'Analitika bazike',
        planStarterFeature4: 'Mbështetje përmes email',
        planProName: 'Pro',
        planProPrice: '$49',
        planProDesc: 'Për dyqanet e berbershmërisë në rritje',
        planProBadge: 'Më i Popullarit',
        planProFeature1: 'Gjithçka në Starter',
        planProFeature2: 'Deri në 10 anëtarë ekipi',
        planProFeature3: 'Analitika dhe raportet e avancuara',
        planProFeature4: 'Mbështetja e përparësisë',
        planEnterpriseName: 'Enterprise',
        planEnterprisePrice: 'Custom',
        planEnterpriseDesc: 'Për zinxhirë të mëdhenj dhe franshiza',
        planEnterpriseFeature1: 'Gjithçka e pakufizuar',
        planEnterpriseFeature2: 'Integrime të përshtatshme',
        planEnterpriseFeature3: 'Mbështetje e dedikuar 24/7',
        planCTA: 'Filloni',
        planContactUs: 'Kontaktoni ne',
        footerColSupport: 'Mbështetje',
        linkFeatures: 'Karakteristikat',
        linkPricing: 'Çmimet',
        linkDemo: 'Demo',
        linkHelp: 'Qendra e Ndihmës',
        linkContact: 'Kontakti',
