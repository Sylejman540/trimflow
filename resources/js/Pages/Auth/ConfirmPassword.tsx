...
import { ArrowRight, ShieldCheck, Eye, EyeOff, Lock, Star } from 'lucide-react';
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 sm:px-12 md:px-20 py-12 bg-white">
                ...
                <div className="w-full max-w-[380px]">
                    <div className="mb-10">
                        ...
                        <h2 className="text-4xl font-bold tracking-tight text-slate-900 mb-2">{t('auth.confirmHeading')}</h2>
                        <p className="text-slate-500 text-sm">{t('auth.confirmSub')}</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-7">
                        ...
                        <div className="pt-2">
                            ...
                            >
                                {processing ? t('auth.verifying') : t('auth.confirmButton')}
