...
export default function Register() {
    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-white font-sans selection:bg-slate-100">
            ...
            {/* --- LEFT SIDE: Minimalist Sage Panel --- */}
            ...
            {/* --- RIGHT SIDE: Form --- */}
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-8 md:px-20 py-12 bg-white relative overflow-y-auto">
                {/* Mobile Logo */}
                ...
                <div className="w-full max-w-[440px] mt-16 lg:mt-0">
                    <div className="mb-12">
                        <h2 className="text-3xl font-light tracking-tight text-slate-900 mb-3">Get started</h2>
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Studio Name</Label>
                                <Input
                                    value={data.shop_name}
                                    className="h-10 rounded-none border-0 border-b border-slate-200 bg-transparent px-0 focus-visible:ring-0 focus-visible:border-slate-900 transition-all placeholder:text-slate-300 font-light"
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Owner Name</Label>
                                <Input
                                    value={data.name}
                                    className="h-10 rounded-none border-0 border-b border-slate-200 bg-transparent px-0 focus-visible:ring-0 focus-visible:border-slate-900 transition-all placeholder:text-slate-300 font-light"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3 relative">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        value={data.password}
                                        className="h-10 rounded-none border-0 border-b border-slate-200 bg-transparent px-0 focus-visible:ring-0 focus-visible:border-slate-900 transition-all font-light pr-10"
                                        onChange={(e) => setData('password', e.target.value)}
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute right-0 top-1/2 -translate-y-1/2 text-slate-300 hover:text-slate-900"
                                    >
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Confirm</Label>
                                <Input
                                    type={showPassword ? "text" : "password"}
                                    value={data.password_confirmation}
                                    className="h-10 rounded-none border-0 border-b border-slate-200 bg-transparent px-0 focus-visible:ring-0 focus-visible:border-slate-900 transition-all font-light"
                        ...
                        <div className="pt-6">
                            ...
                            >
                                ...
                                {!processing && <ArrowRight className="absolute right-6 h-4 w-4 transition-transform group-hover:translate-x-1" />}
                            </button>
                        </div>

                        <p className="text-center text-[11px] text-slate-400 font-light pt-4">
