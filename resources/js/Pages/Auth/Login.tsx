        ...
        <div className="flex h-screen w-full overflow-hidden bg-white font-sans relative">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-8 md:px-20 py-12 bg-white overflow-y-auto">
                <div className="w-full max-w-[400px] mt-12 lg:mt-0">
                    ...
                    {status && <div className="mb-4 text-sm font-bold text-emerald-600 bg-emerald-50 p-3 rounded-xl">{status}</div>}
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input
                                type="email"
                                value={data.email}
                                className="h-12 rounded-xl border-slate-200 bg-slate-50/50 focus:ring-slate-950 transition-all"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    value={data.password}
                                    className="h-12 rounded-xl border-slate-200 bg-slate-50/50 focus:ring-slate-950 transition-all pr-10"
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="group flex h-14 w-full items-center justify-center gap-3 rounded-full bg-slate-950 text-sm font-bold text-white transition-all hover:scale-[1.01] active:scale-[0.99] shadow-xl shadow-slate-200"
                        >
                            SIGN IN
